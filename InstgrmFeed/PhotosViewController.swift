...
//  InstgrmFeed
//
//  Created by Tran Khanh Trung on 3/18/17.
...
//Khanh Trung
let USER_ID = "332386806"
// get from http://instagram.pixelunion.net/
let ACCESS_TOKEN = "332386806.1677ed0.3aa1cb5c7b3e47cc8091f3a8d2ca1e92"
...
extension PhotosViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        photoCell.userImageView.setImageWith(URL(string: userProfilePicUrl as! String)!)
